...
export const aiJobStats = [
  ...
  },
  {
    ...
    label: "Net global job growth by 2030",
  },
];
...
export const aiCurriculumTools = [
  { name: "ChatGPT", mark: "GPT", tone: "bg-emerald-500/80" },
  { name: "OpenAI", mark: "AI", tone: "bg-zinc-900" },
  { name: "Midjourney", mark: "MJ", tone: "bg-yellow-500/85" },
  { name: "Replit", mark: "R", tone: "bg-orange-500/85" },
  { name: "Notion", mark: "N", tone: "bg-zinc-100 text-black" },
  { name: "Gemini", mark: "G", tone: "bg-sky-500/85" },
  { name: "Claude", mark: "CL", tone: "bg-amber-700/85" },
  { name: "Copilot", mark: "CP", tone: "bg-violet-500/85" },
  { name: "Perplexity", mark: "PX", tone: "bg-cyan-500/85" },
  { name: "Figma AI", mark: "F", tone: "bg-pink-500/85" },
  { name: "Cursor", mark: "CU", tone: "bg-black" },
  { name: "Bolt", mark: "B", tone: "bg-lime-500/85" },
];
